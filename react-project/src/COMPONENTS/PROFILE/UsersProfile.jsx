    ...
    <div>
      <div className="background__container">
        ...
        >
          ...
          <Typography
            variant="h5"
            sx={{ color: "white", fontFamily: "inherit", padding: "10px" }}
          >
            User Flats:
          </Typography>
        </div>
        ...
        <Box
          sx={{ height: 300, width: "82.2%", margin: "auto", color: "white" }}
        >
          <DataGrid
            rows={userData.flats}
            columns={columns}
